...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Mar 2023 pada 00.01
...
INSERT INTO `kabupaten` (`kabupaten_id`, `provinsi_id`, `kabupaten_nama`) VALUES
...
CREATE TABLE `kelas` (
  ...
  `kelas_mulai` int(11) NOT NULL DEFAULT 0,
  `kelas_selesai` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `kelas` (`kelas_id`, `kelas_nama`, `kelas_mulai`, `kelas_selesai`) VALUES
(1, 'Diniyah Kelas 1', 0, 50),
(2, 'Diniyah Kelas 2', 51, 80),
(3, 'Diniyah Kelas 3', 81, 100);
...
(1, '2021-02-15-140051', 'App\\Database\\Migrations\\Role', 'default', 'App', 1677711564, 1),
(2, '2021-02-15-140223', 'App\\Database\\Migrations\\Pengguna', 'default', 'App', 1677711565, 1),
(3, '2021-02-16-014750', 'App\\Database\\Migrations\\Pendaftaran', 'default', 'App', 1677711567, 1),
(4, '2021-02-16-150845', 'App\\Database\\Migrations\\Kelas', 'default', 'App', 1677711570, 1),
(5, '2021-02-16-153857', 'App\\Database\\Migrations\\Program', 'default', 'App', 1677711571, 1),
(6, '2021-02-16-155907', 'App\\Database\\Migrations\\Provinsi', 'default', 'App', 1677711572, 1),
(7, '2021-02-16-160457', 'App\\Database\\Migrations\\Kabupaten', 'default', 'App', 1677711573, 1),
(8, '2021-02-16-160816', 'App\\Database\\Migrations\\Kecamatan', 'default', 'App', 1677711574, 1),
(9, '2021-02-16-162135', 'App\\Database\\Migrations\\Soal', 'default', 'App', 1677711575, 1),
(10, '2021-02-16-172951', 'App\\Database\\Migrations\\PendaftarSantri', 'default', 'App', 1677711581, 1);
...
CREATE TABLE `pendaftaran` (
  ...
  `pendaftaran_periode` varchar(255) NOT NULL,
  `pendaftaran_tgl_mulai` timestamp NOT NULL DEFAULT '2023-03-01 22:59:25',
  `pendaftaran_tgl_selesai` timestamp NOT NULL DEFAULT '2023-03-01 22:59:25',
  `pendaftaran_kuota` int(11) NOT NULL,
  `pendaftaran_status` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `pendaftaran` (`pendaftaran_id`, `pendaftaran_periode`, `pendaftaran_tgl_mulai`, `pendaftaran_tgl_selesai`, `pendaftaran_kuota`, `pendaftaran_status`) VALUES
(1, 'feb - maret', '2021-02-15 17:00:00', '2021-03-16 16:59:59', 100, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `pendaftar_santri`
--

CREATE TABLE `pendaftar_santri` (
  `pendaftar_santri_id` int(11) UNSIGNED NOT NULL,
  `pendaftar_santri_no_daftar` varchar(255) NOT NULL,
  `pendaftaran_id` int(11) UNSIGNED NOT NULL,
  `pengguna_id` int(11) UNSIGNED NOT NULL,
  `pendaftar_santri_jk` varchar(255) DEFAULT NULL,
  `pendaftar_santri_alamat` text DEFAULT NULL,
  `kecamatan_id` int(11) UNSIGNED DEFAULT NULL,
  `kabupaten_id` int(11) UNSIGNED DEFAULT NULL,
  `provinsi_id` int(11) UNSIGNED DEFAULT NULL,
  `pendaftar_santri_tempat_lahir` varchar(255) DEFAULT NULL,
  `pendaftar_santri_tgl_lahir` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `pendaftar_santri_goldar` varchar(255) DEFAULT NULL,
  `pendaftar_santri_anak_ke` int(11) DEFAULT NULL,
  `pendaftar_santri_jml_sdr` int(11) DEFAULT NULL,
  `pendaftar_santri_notelp` varchar(255) DEFAULT NULL,
  `pendaftar_santri_cita` varchar(255) DEFAULT NULL,
  `pendaftar_santri_hobi` varchar(255) DEFAULT NULL,
  `pendaftar_santri_asal_sekolah` varchar(255) DEFAULT NULL,
  `pendaftar_santri_prestasi` varchar(255) DEFAULT NULL,
  `program_id` int(11) UNSIGNED DEFAULT NULL,
  `pendaftar_santri_nama_ayah` varchar(255) DEFAULT NULL,
  `pendaftar_santri_nama_ibu` varchar(255) DEFAULT NULL,
  `pendaftar_santri_kerja_ayah` varchar(255) DEFAULT NULL,
  `pendaftar_santri_kerja_ibu` varchar(255) DEFAULT NULL,
  `pendaftar_santri_alamat_ortu` text DEFAULT NULL,
  `pendaftar_santri_penghasilan_ortu` varchar(255) DEFAULT NULL,
  `pendaftar_santri_ktp` varchar(255) DEFAULT NULL,
  `pendaftar_santri_foto` varchar(255) DEFAULT NULL,
  `pendaftar_santri_kk` varchar(255) DEFAULT NULL,
  `pendaftar_santri_pembayaran` varchar(255) DEFAULT NULL,
  `pendaftar_santri_notelp_ortu` varchar(255) DEFAULT NULL,
  `pendaftar_santri_kelas` varchar(255) DEFAULT NULL,
  `pendaftar_santri_status` int(1) NOT NULL DEFAULT 0,
  `pendaftar_santri_status_by` int(11) UNSIGNED DEFAULT NULL,
  `pendaftar_santri_status_at` timestamp NOT NULL DEFAULT '2023-03-01 22:59:36',
  `pendaftar_santri_created` timestamp NOT NULL DEFAULT '2023-03-01 22:59:36'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `pengguna` (
  `pengguna_id` int(11) UNSIGNED NOT NULL,
  `pengguna_nik` varchar(255) NOT NULL,
  `pengguna_nama` varchar(255) NOT NULL,
  `pengguna_email` varchar(255) NOT NULL,
  `pengguna_password` varchar(255) NOT NULL,
  `role_id` int(11) UNSIGNED NOT NULL,
  `pengguna_created` timestamp NOT NULL DEFAULT '2023-03-01 22:59:24',
  `pengguna_updated` timestamp NOT NULL DEFAULT '2023-03-01 22:59:24'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `pengguna` (`pengguna_id`, `pengguna_nik`, `pengguna_nama`, `pengguna_email`, `pengguna_password`, `role_id`, `pengguna_created`, `pengguna_updated`) VALUES
(1, 'superadmin', 'superadmin', 'superadmin@test.com', '$2y$10$vZcTkyYoDJElJsclcKbQTOSuHoNw/AfUaoF0glKebvtXaxVmjgRkG', 1, '2023-03-01 23:00:06', '2023-03-01 23:00:06'),
(2, 'admin', 'admin', 'admin@test.com', '$2y$10$vZcTkyYoDJElJsclcKbQTOSuHoNw/AfUaoF0glKebvtXaxVmjgRkG', 2, '2023-03-01 23:00:06', '2023-03-01 23:00:06'),
(3, '330411', 'heraya', 'heraya@test.com', '$2y$10$vZcTkyYoDJElJsclcKbQTOSuHoNw/AfUaoF0glKebvtXaxVmjgRkG', 3, '2023-03-01 23:00:06', '2023-03-01 23:00:06');
...
INSERT INTO `program` (`program_id`, `program_nama`) VALUES
(1, 'Bahasa Arab'),
(2, 'Bahasa Inggris'),
(3, 'Kitab'),
(4, 'Tahfidz');
...
CREATE TABLE `soal` (
  ...
  `soal_soal` text NOT NULL,
  `soal_a` varchar(255) DEFAULT NULL,
  `soal_b` varchar(255) DEFAULT NULL,
  `soal_c` varchar(255) DEFAULT NULL,
  `soal_d` varchar(255) DEFAULT NULL,
  `soal_kunci` varchar(255) DEFAULT NULL,
  `soal_aktif` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `soal` (`soal_id`, `soal_soal`, `soal_a`, `soal_b`, `soal_c`, `soal_d`, `soal_kunci`, `soal_aktif`) VALUES
...
--
-- Indeks untuk tabel `pendaftar_santri`
--
ALTER TABLE `pendaftar_santri`
  ADD PRIMARY KEY (`pendaftar_santri_id`),
  ADD KEY `pendaftar_santri_pendaftaran_id_foreign` (`pendaftaran_id`),
  ADD KEY `pendaftar_santri_pengguna_id_foreign` (`pengguna_id`),
  ADD KEY `pendaftar_santri_kecamatan_id_foreign` (`kecamatan_id`),
  ADD KEY `pendaftar_santri_kabupaten_id_foreign` (`kabupaten_id`),
  ADD KEY `pendaftar_santri_provinsi_id_foreign` (`provinsi_id`),
  ADD KEY `pendaftar_santri_program_id_foreign` (`program_id`),
  ADD KEY `pendaftar_santri_pendaftar_santri_status_by_foreign` (`pendaftar_santri_status_by`);
...
ALTER TABLE `pengguna`
  ...
  ADD UNIQUE KEY `pengguna_nik` (`pengguna_nik`),
...
--
ALTER TABLE `kabupaten`
  MODIFY `kabupaten_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9472;

--
-- AUTO_INCREMENT untuk tabel `kecamatan`
--
ALTER TABLE `kecamatan`
  MODIFY `kecamatan_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9471041;

--
-- AUTO_INCREMENT untuk tabel `kelas`
--
ALTER TABLE `kelas`
  MODIFY `kelas_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pendaftaran`
  MODIFY `pendaftaran_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `pendaftar_santri`
--
ALTER TABLE `pendaftar_santri`
  MODIFY `pendaftar_santri_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `pengguna`
--
ALTER TABLE `pengguna`
  MODIFY `pengguna_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `program`
--
ALTER TABLE `program`
  MODIFY `program_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `provinsi`
--
ALTER TABLE `provinsi`
  MODIFY `provinsi_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `soal`
  MODIFY `soal_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `kabupaten`
  ADD CONSTRAINT `kabupaten_provinsi_id_foreign` FOREIGN KEY (`provinsi_id`) REFERENCES `provinsi` (`provinsi_id`);

--
-- Ketidakleluasaan untuk tabel `kecamatan`
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `kecamatan_kabupaten_id_foreign` FOREIGN KEY (`kabupaten_id`) REFERENCES `kabupaten` (`kabupaten_id`);

--
-- Ketidakleluasaan untuk tabel `pendaftar_santri`
--
ALTER TABLE `pendaftar_santri`
  ADD CONSTRAINT `pendaftar_santri_kabupaten_id_foreign` FOREIGN KEY (`kabupaten_id`) REFERENCES `kabupaten` (`kabupaten_id`),
  ADD CONSTRAINT `pendaftar_santri_kecamatan_id_foreign` FOREIGN KEY (`kecamatan_id`) REFERENCES `kecamatan` (`kecamatan_id`),
  ADD CONSTRAINT `pendaftar_santri_pendaftar_santri_status_by_foreign` FOREIGN KEY (`pendaftar_santri_status_by`) REFERENCES `pengguna` (`pengguna_id`),
  ADD CONSTRAINT `pendaftar_santri_pendaftaran_id_foreign` FOREIGN KEY (`pendaftaran_id`) REFERENCES `pendaftaran` (`pendaftaran_id`),
  ADD CONSTRAINT `pendaftar_santri_pengguna_id_foreign` FOREIGN KEY (`pengguna_id`) REFERENCES `pengguna` (`pengguna_id`),
  ADD CONSTRAINT `pendaftar_santri_program_id_foreign` FOREIGN KEY (`program_id`) REFERENCES `program` (`program_id`),
  ADD CONSTRAINT `pendaftar_santri_provinsi_id_foreign` FOREIGN KEY (`provinsi_id`) REFERENCES `provinsi` (`provinsi_id`);

--
-- Ketidakleluasaan untuk tabel `pengguna`
--
ALTER TABLE `pengguna`
  ADD CONSTRAINT `pengguna_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`);
COMMIT;
